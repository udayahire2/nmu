...
import { Plus, Search, Zap, Trash2, Edit, UploadCloud } from 'lucide-react';
...
export default function RevisionPage() {
    ...
    const revisionList = [
        { id: 1, course: 'BCA', semester: 'Sem 1', subject: 'C Programming', topic: 'Important Questions', fileName: 'c_prog_imp_ques.pdf' },
        { id: 2, course: 'B.Sc CS', semester: 'Sem 3', subject: 'Data Structures', topic: 'Formula Cheat Sheet', fileName: 'ds_cheat_sheet.pdf' },
    ];
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Quick Revision</h1>
                    <p className="text-zinc-500 dark:text-zinc-400">Manage cheat sheets and revision materials.</p>
                </div>
            ...
            <Modal
                ...
                description="Upload quick revision notes or cheat sheets."
                footer={
                    <>
            ...
            >
                <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input placeholder="e.g. Unit 1 Summary" />
                    </div>

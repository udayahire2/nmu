...
export function NavbarMobileCalm() {
    ...
    const getDescription = (path: string) => {
        if (path === "/") return "Overview and updates"
        if (path === "/resources") return "Notes, PDFs and material"
        if (path === "/syllabus") return "Subjects and units"
    ...
    return (
        <Dialog>
            ...
            <DialogContent
                ...
                className="left-auto right-0 top-0 h-dvh w-full max-w-sm translate-x-0 translate-y-0 gap-0 rounded-none border-y-0 border-r-0 p-0 sm:max-w-sm"
            >
                            ...
                            <CardContent className="space-y-4 p-4">
                                <div className="space-y-1">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Sign in to keep your materials and syllabus in one place.
                                    </p>
                                </div>
